...
urlpatterns = [
    ...
    url(r'chat_detail/$', ChatDetailPageView.as_view(), name='chat_detail'),
    url(r'chat_video_detail/$', ChatVideoDetailPageView.as_view(), name='chat_video_detail'),
